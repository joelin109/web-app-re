...
export default class App extends React.Component {
  constructor(props) {
    ...
    this._dispatch_header_channel = this._dispatch_header_channel.bind(this);
  }
  ...
  render() {
    ...
    const Geek = asyncComponent(() =>
      import(/* webpackChunkName: "chunk/index.bundle.geek" */ "./c-geek")
    );
    const Channel = asyncComponent(() =>
      import(/* webpackChunkName: "chunk/index.bundle.channel" */ "./c-channel")
    );
    const Deutsch = asyncComponent(() =>
      import(/* webpackChunkName: "chunk/index.bundle.deutsch" */ "./c-deutsch")
    );
    ...
    return (
      <div>
        <Header
          title="Joe.c"
          dispatch={this._dispatch_header_navigator.bind(this)}
        />
        <HeaderChannel
          value={3}
          hidden={_isModal}
          dispatch={this._dispatch_header_channel}
        />
